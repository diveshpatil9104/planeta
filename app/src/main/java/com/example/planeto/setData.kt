    ...
    fun SetPlanets():List<PlanetData>{
        ...
        Planetlist.add(
            PlanetData(
                ...
                "149.6",
                "9.807",
                "Earth is the third planet from the sun and is the only known planet to support life. It has a diverse climate, with polar ice caps, deserts, rainforests, and temperate regions. The planet has a solid surface, with 71% of the surface covered by oceans and 29% covered by land. Earth has a single large natural satellite, the Moon. It has a strong magnetic field and an atmosphere that protects life on the planet from harmful solar radiation. The atmosphere also plays a crucial role in maintaining the planet's climate and weather patterns. The Earth's rotation on its axis causes the phenomenon of day and night, and its orbit around the sun causes the seasons. The earth have various forms of life such as animals, plants, and microorganisms, which have evolved to survive in different environments. Earth is a terrestrial planet, meaning it is a rocky planet that is primarily composed of silicate rocks or metals. It has a metallic core, a rocky mantle, and a thin outer layer of solid crust. The planet's surface is constantly changing, shaped by processes such as erosion, tectonics, and volcanic activity "
            )
        )
        Planetlist.add(
            PlanetData(
